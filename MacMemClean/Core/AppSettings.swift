...
final class AppSettings: ObservableObject {
    ...
    /// Hides the Dock icon entirely — MacMemClean becomes a pure menu-bar app, reachable only via
    /// the menu bar dropdown's "Open MacMemClean" row (still there either way) or the wind icon.
